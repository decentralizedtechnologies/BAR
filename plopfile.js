...
const reactComponentGenerator = (plop) => ({
  ...
  actions: (data) => {
    const actions = [
      {
        type: "add",
        path: `src/${data.baseDir}/{{directory}}/{{pascalCase name}}/{{pascalCase name}}.tsx`,
        templateFile: "plop-templates/component/Component.hbs",
      },
      {
        type: "add",
        path: `src/${data.baseDir}/{{directory}}/{{pascalCase name}}/{{pascalCase name}}.test.tsx`,
        templateFile: "plop-templates/component/Component.test.hbs",
      },
      {
        type: "add",
        path: `src/${data.baseDir}/{{directory}}/{{pascalCase name}}/{{pascalCase name}}.types.ts`,
    ...
    if (data.addStyles) {
      const baseFilePath = path
        .relative(`src/${data.baseDir}/{{directory}}/{{pascalCase name}}`, "src/theme/_base.scss")
        .replace("../", "")
        .replace(".scss", "");
      ...
      actions.push({
        type: "add",
        path: `src/${data.baseDir}/{{directory}}/{{pascalCase name}}/{{pascalCase name}}.module.scss`,
    ...
    if (data.addContainer) {
      actions.push({
        type: "add",
        path: `src/${data.baseDir}/{{directory}}/{{pascalCase name}}/{{pascalCase name}}Container.tsx`,
    ...
    if (data.addStory) {
      actions.push({
        type: "add",
        path: `src/${data.baseDir}/{{directory}}/{{pascalCase name}}/{{pascalCase name}}.story.tsx`,
...
const pageGenerator = () => ({
  ...
  actions: () => {
    const actions = [
      {
        type: "add",
        path: "src/pages/{{directory}}/{{pascalCase name}}.tsx",
